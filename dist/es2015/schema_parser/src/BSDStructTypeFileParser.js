...
export class BSDStructTypeFileParser extends BSDClassFileParser {
    ...
    createChildElement(el) {
        ...
        let mem = new ClassMember((attrName) ? attrName.value : null, (attrTypeName) ? attrTypeName.value : null, true, null, bitLength, isArr);
    ...
    createConstructor() {
        ...
        let met = new ClassMethod(null, null, "constructor", args, null, body);
    ...
    createEncodeMethod() {
        ...
        let enc = new ClassMethod("", null, "encode", [new ClassMember("out", ClassFile.IO_TYPE)], null, body);
    ...
    createDecodeMethod() {
        ...
        let dec = new ClassMethod("", null, "decode", [new ClassMember("inp", ClassFile.IO_TYPE)], null, body);
        this.cls.addMethod(dec);
        //create decode as array method
        body = "\t\tlet obj = new " + this.cls.Name + "();\n";
        body += "\t\t\tobj.decode(inp); \n\t\t\treturn obj;\n";
        let fnDec = new ClassMethod(null, this.cls.Name, "decode" + this.cls.Name, [new ClassMember("inp", ClassFile.IO_TYPE)], null, body);
        this.cls.addUtilityFunction(fnDec);
    }
    createDecodeEncodingByteCode() {
        if (!this.encodingByteMap) {
            return "";
        }
    ...
    createCloneMethod() {
        ...
        body += "\t\treturn target;";
        let cl = new ClassMethod("", this.cls, "clone", [new ClassMember("target", this.cls, false)], null, body);
...
//# sourceMappingURL=BSDStructTypeFileParser.js.map