...
export class NodeId {
     ...
     * @constructor
     */
    constructor(identifierType, value, namespace = 0) {
 ...
 * @return {NodeId}
 */
export function makeNodeId(value, namespace) {
    value = value || 0;
...
function from_hex(str) {
    var size = str.length / 2, buf = new Uint8Array(size), character = '';
 ...
 */
export function coerceNodeId(value, namespace) {
