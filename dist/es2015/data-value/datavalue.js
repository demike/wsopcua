...
export function sourceTimestampHasChanged(dataValue1, dataValue2) {
    ...
    var hasChanged = !sameDate(dataValue1.sourceTimestamp, dataValue2.sourceTimestamp) ||
...
export function serverTimestampHasChanged(dataValue1, dataValue2) {
    assert(dataValue1, "expecting valid dataValue1");
    assert(dataValue2, "expecting valid dataValue2");
    var hasChanged = !sameDate(dataValue1.serverTimestamp, dataValue2.serverTimestamp) ||
 ...
 */
export function sameDataValue(v1, v2, timestampsToReturn) {
    if (v1 === v2) {
        return true;
    }
    if (v1 && !v2) {
