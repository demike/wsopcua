...
export function privateDecrypt_long(buffer, key, block_size, algorithm) {
    throw new Error("not implemented");
}
export function rsa_length(key) {
    throw new Error("not implemented");
}
 ...
 */
export function verifyMessageChunkSignature(block_to_verify, signature, options) {
    throw new Error("not implemented");
}
