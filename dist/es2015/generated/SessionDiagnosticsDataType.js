...
export class SessionDiagnosticsDataType {
    ...
    clone(target) {
        ...
        if (this.totalRequestCount) {
            target.totalRequestCount = this.totalRequestCount.clone();
        }
        target.unauthorizedRequestCount = this.unauthorizedRequestCount;
        if (this.readCount) {
            target.readCount = this.readCount.clone();
        }
        if (this.historyReadCount) {
            target.historyReadCount = this.historyReadCount.clone();
        }
        if (this.writeCount) {
            target.writeCount = this.writeCount.clone();
        }
        if (this.historyUpdateCount) {
            target.historyUpdateCount = this.historyUpdateCount.clone();
        }
        if (this.callCount) {
            target.callCount = this.callCount.clone();
        }
        if (this.createMonitoredItemsCount) {
            target.createMonitoredItemsCount = this.createMonitoredItemsCount.clone();
        }
        if (this.modifyMonitoredItemsCount) {
            target.modifyMonitoredItemsCount = this.modifyMonitoredItemsCount.clone();
        }
        if (this.setMonitoringModeCount) {
            target.setMonitoringModeCount = this.setMonitoringModeCount.clone();
        }
        if (this.setTriggeringCount) {
            target.setTriggeringCount = this.setTriggeringCount.clone();
        }
        if (this.deleteMonitoredItemsCount) {
            target.deleteMonitoredItemsCount = this.deleteMonitoredItemsCount.clone();
        }
        if (this.createSubscriptionCount) {
            target.createSubscriptionCount = this.createSubscriptionCount.clone();
        }
        if (this.modifySubscriptionCount) {
            target.modifySubscriptionCount = this.modifySubscriptionCount.clone();
        }
        if (this.setPublishingModeCount) {
            target.setPublishingModeCount = this.setPublishingModeCount.clone();
        }
        if (this.publishCount) {
            target.publishCount = this.publishCount.clone();
        }
        if (this.republishCount) {
            target.republishCount = this.republishCount.clone();
        }
        if (this.transferSubscriptionsCount) {
            target.transferSubscriptionsCount = this.transferSubscriptionsCount.clone();
        }
        if (this.deleteSubscriptionsCount) {
            target.deleteSubscriptionsCount = this.deleteSubscriptionsCount.clone();
        }
        if (this.addNodesCount) {
            target.addNodesCount = this.addNodesCount.clone();
        }
        if (this.addReferencesCount) {
            target.addReferencesCount = this.addReferencesCount.clone();
        }
        if (this.deleteNodesCount) {
            target.deleteNodesCount = this.deleteNodesCount.clone();
        }
        if (this.deleteReferencesCount) {
            target.deleteReferencesCount = this.deleteReferencesCount.clone();
        }
        if (this.browseCount) {
            target.browseCount = this.browseCount.clone();
        }
        if (this.browseNextCount) {
            target.browseNextCount = this.browseNextCount.clone();
        }
        if (this.translateBrowsePathsToNodeIdsCount) {
            target.translateBrowsePathsToNodeIdsCount = this.translateBrowsePathsToNodeIdsCount.clone();
        }
        if (this.queryFirstCount) {
            target.queryFirstCount = this.queryFirstCount.clone();
        }
        if (this.queryNextCount) {
            target.queryNextCount = this.queryNextCount.clone();
        }
        if (this.registerNodesCount) {
            target.registerNodesCount = this.registerNodesCount.clone();
        }
        if (this.unregisterNodesCount) {
            target.unregisterNodesCount = this.unregisterNodesCount.clone();
        }
        return target;
    }
}
export function decodeSessionDiagnosticsDataType(inp) {
...
//# sourceMappingURL=SessionDiagnosticsDataType.js.map