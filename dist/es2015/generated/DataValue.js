...
export class DataValue {
    ...
    encode(out) {
        ...
        if (this.sourceTimestamp != null) {
            ec.encodeDateTime(this.sourceTimestamp, out);
        }
        if (this.sourcePicoseconds != null) {
            ec.encodeUInt16(this.sourcePicoseconds, out);
        }
        if (this.serverTimestamp != null) {
            ec.encodeDateTime(this.serverTimestamp, out);
        }
        if (this.serverPicoseconds != null) {
            ec.encodeUInt16(this.serverPicoseconds, out);
        }
    }
    decode(inp) {
...
export function decodeDataValue(inp) {
