...
;
export function encodeFloat(value, stream) {
    stream.setFloat32(value);
}
;
export function decodeFloat(stream) {
...
;
export function encodeDouble(value, stream) {
    stream.setFloat64(value);
}
;
export function decodeDouble(stream) {
