...
export const oid_map: { [key: string]: { d: string; c: string; w?: boolean } } = {
  ...
  '1.3.6.1.4.1.311.2.1.21': {
    d: '1.3.6.1.4.1.311.2.1.21',
    c: 'SPC_INDIVIDUAL_SP_KEY_PURPOSE_OBJID',
  },
  '1.3.6.1.4.1.311.2.1.22': {
    d: '1.3.6.1.4.1.311.2.1.22',
    c: 'SPC_COMMERCIAL_SP_KEY_PURPOSE_OBJID',
  },
  '1.3.6.1.4.1.311.10.3.1': {
    d: '1.3.6.1.4.1.311.10.3.1',
    c: 'Signer of CTLs -- szOID_KP_CTL_USAGE_SIGNING',
  },
  '1.3.6.1.4.1.311.10.3.4': {
    d: '1.3.6.1.4.1.311.10.3.4',
    c: 'szOID_EFS_RECOVERY (Encryption File System)',
  },
