...
import {VariantArrayType} from '../../variant/VariantArrayTypeEnum';
 ...
 * @return {boolean}
 */
export function check_deadband(variant1,variant2,deadbandType : DeadbandType,deadbandValue:number,valueRange?:number) {
