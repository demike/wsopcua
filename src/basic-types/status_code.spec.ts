...
describe('testing status code manipulation', function () {
  ...
  it('should encode and decode a status code', function () {
    ...
    expect(statusCode2.description).toEqual(
  ...
  it('should coerce a number to a status code', () => {
    ...
    expect(coerceStatusCode(StatusCodes.BadAggregateConfigurationRejected.value)).toEqual(
  ...
  it('should coerce a status code', () => {
    expect(coerceStatusCode(StatusCodes.BadAggregateConfigurationRejected)).toEqual(
      StatusCodes.BadAggregateConfigurationRejected
    );
  });
  ...
  it('equals', () => {
    expect(
      StatusCodes.BadAggregateConfigurationRejected.equals(
        StatusCodes.BadAggregateConfigurationRejected
      )
    ).toEqual(true);
  });
  ...
  it('equals', () => {
    expect(StatusCodes.BadAggregateConfigurationRejected.equals(StatusCodes.BadNoData)).toEqual(
      false
    );
  });
  ...
  it('isNot', () => {
    expect(
      StatusCodes.BadAggregateConfigurationRejected.isNot(
        StatusCodes.BadAggregateConfigurationRejected
      )
    ).toEqual(false);
  });
  ...
  it('isNot', () => {
    expect(StatusCodes.BadAggregateConfigurationRejected.isNot(StatusCodes.BadNoData)).toEqual(
      true
    );
  });
...
describe('ModifiableStatusCode', () => {
  ...
  it('test with extra bits 1', () => {
    ...
    expect(statusCode.toString()).toEqual(
      'UncertainDataSubNormal#HistorianCalculated (0x40a40001)'
    );
  });
  it('test with extra bits 2', () => {
    const statusCode = makeStatusCode(StatusCodes.UncertainDataSubNormal, 'HistorianInterpolated');
    expect(statusCode.toString()).toEqual(
      'UncertainDataSubNormal#HistorianInterpolated (0x40a40002)'
    );
  });
  it('test with extra bits 3', () => {
    const statusCode = makeStatusCode(StatusCodes.UncertainDataSubNormal, 'HistorianCalculated');
    const statusCode2 = makeStatusCode(statusCode, 'HistorianInterpolated');
    expect(statusCode2.toString()).toEqual(
      'UncertainDataSubNormal#HistorianCalculated|HistorianInterpolated (0x40a40003)'
    );
  });
  it('test with extra bits 4', () => {
    ...
    expect(statusCode2.toString()).toEqual(
      'UncertainDataSubNormal#HistorianCalculated (0x41480001)'
    );
  });
