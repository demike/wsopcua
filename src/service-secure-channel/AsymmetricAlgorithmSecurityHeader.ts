...
export class AsymmetricAlgorithmSecurityHeader {
  ...
  toJSON() {
    ...
    out.senderCertificate = jsonEncodeByteString(this.senderCertificate);
    out.receiverCertificateThumbprint = jsonEncodeByteString(this.receiverCertificateThumbprint);
    return out;
  }
  ...
  fromJSON(inp: any) {
    ...
    this.senderCertificate = jsonDecodeByteString(inp.senderCertificate);
    this.receiverCertificateThumbprint = jsonDecodeByteString(inp.receiverCertificateThumbprint);
  }
...
import { jsonDecodeByteString, jsonEncodeByteString } from '../basic-types';
