...
export type HistoryReadRawResult = Omit<HistoryReadResult, 'historyData'> & {
  historyData: HistoryData;
};
export type HistoryReadModifiedResult = Omit<HistoryReadResult, 'historyData'> & {
  historyData: HistoryModifiedData;
};
export type HistoryReadEventResult = Omit<HistoryReadResult, 'historyData'> & {
