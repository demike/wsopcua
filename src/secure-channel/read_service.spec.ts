import { makeBuffer } from '../test-util/make_buffer_from_trace';
import { verify_multi_chunk_message } from './test_helpers';
import { ReadRequest } from '../generated/ReadRequest';
import { TimestampsToReturn } from '../generated/TimestampsToReturn';
import { coerceNodeId, ReadValueId } from '../wsopcua';
...
describe('Read Service', function () {
    ...
    it('should decode a real ReadRequest 1/2', function () {

            verify_multi_chunk_message([fixture_ws_readRequest_message]);
    });
    it('should decode a real ReadRequest 2/2', function () {
            verify_multi_chunk_message([fixture_ws_readRequest_message2]);
    });

    it('should decode a real ReadResponse 1/2', function () {
            verify_multi_chunk_message([fixture_ws_readResponse_message]);
    });

    it('should decode a real ReadResponse 2/2', function () {
