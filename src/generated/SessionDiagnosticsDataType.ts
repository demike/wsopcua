...
export class SessionDiagnosticsDataType {
 ...
 constructor( options?: ISessionDiagnosticsDataType) {
  ...
  this.actualSessionTimeout = (options.actualSessionTimeout != null) ? options.actualSessionTimeout : null;
  this.maxResponseMessageSize = (options.maxResponseMessageSize != null) ? options.maxResponseMessageSize : null;
  ...
  this.currentSubscriptionsCount = (options.currentSubscriptionsCount != null) ? options.currentSubscriptionsCount : null;
  this.currentMonitoredItemsCount = (options.currentMonitoredItemsCount != null) ? options.currentMonitoredItemsCount : null;
  this.currentPublishRequestsInQueue = (options.currentPublishRequestsInQueue != null) ? options.currentPublishRequestsInQueue : null;
  this.totalRequestCount = (options.totalRequestCount != null) ? options.totalRequestCount : new ServiceCounterDataType();
  this.unauthorizedRequestCount = (options.unauthorizedRequestCount != null) ? options.unauthorizedRequestCount : null;
