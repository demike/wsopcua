...
export class ProgramDiagnostic2DataType {
 ...
 constructor( options?: IProgramDiagnostic2DataType | undefined) {
  options = options || {};
...
register_class_definition('ProgramDiagnostic2DataType', ProgramDiagnostic2DataType, new ExpandedNodeId(2 /*numeric id*/, 24034, 0));
