...
export class JsonDataSetReaderMessageDataType extends DataSetReaderMessageDataType {
  ...
  constructor(options?: IJsonDataSetReaderMessageDataType) {
    ...
    this.networkMessageContentMask =
      options.networkMessageContentMask != null ? options.networkMessageContentMask : null;
    this.dataSetMessageContentMask =
      options.dataSetMessageContentMask != null ? options.dataSetMessageContentMask : null;
  }
...
export function decodeJsonDataSetReaderMessageDataType(
  inp: DataStream
...
register_class_definition(
  'JsonDataSetReaderMessageDataType',
  JsonDataSetReaderMessageDataType,
  new ExpandedNodeId(2 /*numeric id*/, 15725, 0)
);
