...
export class ThreeDFrame extends Frame {
 ...
 constructor( options?: IThreeDFrame) {
  options = options || {};
  super();
  this.cartesianCoordinates = (options.cartesianCoordinates) ? options.cartesianCoordinates : new ThreeDCartesianCoordinates();
  this.orientation = (options.orientation) ? options.orientation : new ThreeDOrientation();
