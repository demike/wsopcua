...
export type IMonitoredItemModifyResult = Partial<MonitoredItemModifyResult>;
...
register_class_definition('MonitoredItemModifyResult', MonitoredItemModifyResult, new ExpandedNodeId(2 /*numeric id*/, 760, 0));
