...
export class MonitoringParameters {
 ...
 constructor( options?: IMonitoringParameters) {
  options = options || {};
  this.clientHandle = (options.clientHandle != null) ? options.clientHandle : null;
  this.samplingInterval = (options.samplingInterval != null) ? options.samplingInterval : null;
  this.filter = (options.filter != null) ? options.filter : null;
  this.queueSize = (options.queueSize != null) ? options.queueSize : null;
  this.discardOldest = (options.discardOldest != null) ? options.discardOldest : null;
