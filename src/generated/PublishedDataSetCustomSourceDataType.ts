...
export class PublishedDataSetCustomSourceDataType extends PublishedDataSetSourceDataType {
 ...
 constructor( options?: IPublishedDataSetCustomSourceDataType | undefined) {
  options = options || {};
  super();
...
register_class_definition('PublishedDataSetCustomSourceDataType', PublishedDataSetCustomSourceDataType, new ExpandedNodeId(2 /*numeric id*/, 25529, 0));
