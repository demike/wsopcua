...
describe('test DeadBand Checker', function () {
  ...
  const vInt32_1000_Array = new Variant({
    arrayType: VariantArrayType.Array,
    dataType: DataType.Int32,
    value: [1000, 1000],
  });
  const vInt32_1010_Array = new Variant({
    arrayType: VariantArrayType.Array,
    dataType: DataType.Int32,
    value: [1010, 982],
  });
  ...
  it('Array  - DeadbandType.None - should detect difference between two Int scalar', function () {
    expect(check_deadband(vInt32_1000_Array, vInt32_1000_Array, DeadbandType.None, NaN, null)).toBe(
      false
    );
    expect(check_deadband(vInt32_1000_Array, vInt32_1010_Array, DeadbandType.None, NaN, null)).toBe(
      true
    );
  });
  ...
  it('Array  - DeadbandType.Absolute - should detect difference between two Int scalar', function () {
    expect(
      check_deadband(vInt32_1000_Array, vInt32_1000_Array, DeadbandType.Absolute, 5, null)
    ).toBe(false);

    expect(
      check_deadband(vInt32_1000_Array, vInt32_1010_Array, DeadbandType.Absolute, 5, null)
    ).toBe(true);
    expect(
      check_deadband(vInt32_1000_Array, vInt32_1010_Array, DeadbandType.Absolute, 10, null)
    ).toBe(true);
    expect(
      check_deadband(vInt32_1000_Array, vInt32_1010_Array, DeadbandType.Absolute, 20, null)
    ).toBe(false);
  });

  const vInt64_1000 = new Variant({
    arrayType: VariantArrayType.Scalar,
    dataType: DataType.Int64,
    value: [0, 1000],
  });
  const vInt64_1010 = new Variant({
    arrayType: VariantArrayType.Scalar,
    dataType: DataType.Int64,
    value: [0, 1010],
  });
  ...
  const vInt64_L1000 = new Variant({
    arrayType: VariantArrayType.Scalar,
    dataType: DataType.Int64,
    value: [1, 1000],
  });
  const vInt64_L1010 = new Variant({
    arrayType: VariantArrayType.Scalar,
    dataType: DataType.Int64,
    value: [1, 1010],
  });
