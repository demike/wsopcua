...
export async function browseAll(session: BrowseServiceSet, nodesToBrowse: BrowseDescription[]| BrowseDescription): Promise<BrowseResult[]> {
...
/**
   ...
   */
   async function handleBrowseResponse(
    ...
    const browseNextResponse = await session.browseNextP(
        continuationPoints
      );
